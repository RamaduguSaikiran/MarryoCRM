<script>
  ...
  // Color configurations using Marryo design system tokens
  const colorConfig = {
    orange: {
    ...
    amber: {
      iconBg: 'bg-[var(--color-gold-light,hsl(38,50%,93%))] dark:bg-[var(--color-gold-default)]/15',
      iconColor: 'text-[var(--color-gold-default,hsl(38,50%,55%))] dark:text-[var(--color-gold-default)]',
      borderGlow: 'hover:border-[var(--color-gold-default)]/30',
      shadowGlow: 'dark:hover:shadow-[var(--color-gold-default)]/10'
    },
    rose: {
